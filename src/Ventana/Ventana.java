 ...
 * Fecha Creación: 20/03/23           *
 * Fecha Actualización:	20/03/23	  *
 * Descripción: Método Selecciòn      *
 **************************************/
package Ventana;
...
//Implementaciiòn del mètodo Selecciòn
private int[] ordenarArreglo(int[] arr) {
    int n = arr.length;						//length se utilizo para obtener la longitud del arreglo
    for (int i = 0; i < n - 1; i++) {
        int Valormin = i;
        for (int j = i + 1; j < n; j++) {
